...
export default function Navbar() {
  return (
    <nav className='flex justify-between px-[15px] py-[7px] md:px-[50px] md:py-[10px] items-center'>
      ...
      <button className='bg-[#3333ee] px-[20px] py-[5px] items-center text-center text-[#fff] rounded-[5px] cursor-pointer text-[16px] font-[800] md:text-[15px] md:font-[500]  transition'>Login</button>
